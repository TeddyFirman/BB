...
<div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
    ...
    <div class="flex justify-between items-center h-14 bg-blue-800 header-right">
        <div class="bg-white rounded flex items-center w-full max-w-xl mr-4 px-2 shadow-sm border border-gray-200">
            <button class="outline-0 focus:outline-0">
        ...
        <ul class="flex items-center">
            <li>
                <button aria-hidden="true" @click="toggleTheme"
                    class="group p-2 transition-colors duration-200 rounded-full shadow-md bg-blue-200 hover:bg-blue-200 text-gray-900 focus:outline-none">
                    <svg x-show="isDark" width="24" height="24"
                        class="fill-current text-gray-700 group-hover:text-gray-500 group-focus:text-gray-700"
